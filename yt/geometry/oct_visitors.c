/* Generated by Cython 0.20.2 on Wed Sep 10 15:41:06 2014 */
...
#endif
#include <math.h>
#define __PYX_HAVE__yt__geometry__oct_visitors
#define __PYX_HAVE_API__yt__geometry__oct_visitors
#include "string.h"
#include "stdio.h"
#include "stdlib.h"
...
/* "yt/geometry/oct_visitors.pxd":19
 * cimport numpy as np
 * 
 * cdef struct Oct             # <<<<<<<<<<<<<<
 * cdef struct Oct:
...
/* "yt/geometry/oct_visitors.pxd":27
...
/* "yt/geometry/oct_visitors.pxd":41
 *     np.int32_t nz
 * 
...
static CYTHON_INLINE int __pyx_f_2yt_8geometry_12oct_visitors_oind(struct __pyx_t_2yt_8geometry_12oct_visitors_OctVisitorData *); /*proto*/
static CYTHON_INLINE int __pyx_f_2yt_8geometry_12oct_visitors_rind(struct __pyx_t_2yt_8geometry_12oct_visitors_OctVisitorData *); /*proto*/
#define __Pyx_MODULE_NAME "yt.geometry.oct_visitors"
int __pyx_module_is_main_yt__geometry__oct_visitors = 0;

/* Implementation of 'yt.geometry.oct_visitors' */
...
static char __pyx_k_ARRAY_CLUE[] = "ARRAY CLUE: ";
static char __pyx_k_ValueError[] = "ValueError";
static char __pyx_k_RuntimeError[] = "RuntimeError";
static char __pyx_k_SOMETHING_IS_AMISS[] = "SOMETHING IS AMISS";
static char __pyx_k_Oct_visitor_functions[] = "\nOct visitor functions\n\n\n\n\n";
...
static PyObject *__pyx_kp_s_ARRAY_CLUE;
static PyObject *__pyx_kp_u_Format_string_allocated_too_shor;
static PyObject *__pyx_kp_u_Format_string_allocated_too_shor_2;
static PyObject *__pyx_kp_u_Non_native_byte_order_not_suppor;
static PyObject *__pyx_n_s_RuntimeError;
static PyObject *__pyx_kp_s_SOMETHING_IS_AMISS;
...
/* "yt/geometry/oct_visitors.pyx":25
...
static void __pyx_f_2yt_8geometry_12oct_visitors_copy_array_f64(CYTHON_UNUSED struct __pyx_t_2yt_8geometry_12oct_visitors_Oct *__pyx_v_o, struct __pyx_t_2yt_8geometry_12oct_visitors_OctVisitorData *__pyx_v_data, __pyx_t_5numpy_uint8_t __pyx_v_selected) {
  int __pyx_v_i;
  ...
  int __pyx_t_2;
  int __pyx_t_3;
  __Pyx_RefNannySetupContext("copy_array_f64", 0);

  /* "yt/geometry/oct_visitors.pyx":28
 *     # We should always have global_index less than our source.
 *     # "last" here tells us the dimensionality of the array.
 ...
 */
  ...
  /* "yt/geometry/oct_visitors.pyx":31
 *     cdef int i
 *     # There are this many records between "octs"
 ...
 */
  __pyx_v_index = ((__pyx_v_data->global_index * __pyx_v_data->nz) * __pyx_v_data->dims);

  /* "yt/geometry/oct_visitors.pyx":32
 *     # There are this many records between "octs"
 *     cdef np.int64_t index = (data.global_index * data.nz)*data.dims
 *     cdef np.float64_t **p = <np.float64_t**> data.array             # <<<<<<<<<<<<<<
 *     index += oind(data)*data.dims
 ...
 */
  __pyx_v_p = ((__pyx_t_5numpy_float64_t **)__pyx_v_data->array);

  /* "yt/geometry/oct_visitors.pyx":33
 *     cdef np.int64_t index = (data.global_index * data.nz)*data.dims
 *     cdef np.float64_t **p = <np.float64_t**> data.array
 *     index += oind(data)*data.dims             # <<<<<<<<<<<<<<
 *     for i in range(data.dims):
 ...
 */
  __pyx_v_index = (__pyx_v_index + (__pyx_f_2yt_8geometry_12oct_visitors_oind(__pyx_v_data) * __pyx_v_data->dims));

  /* "yt/geometry/oct_visitors.pyx":34
 *     cdef np.float64_t **p = <np.float64_t**> data.array
 *     index += oind(data)*data.dims
 *     for i in range(data.dims):             # <<<<<<<<<<<<<<
 *         p[1][data.index + i] = p[0][index + i]
 ...
 */
  __pyx_t_2 = __pyx_v_data->dims;
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    __pyx_v_i = __pyx_t_3;

    /* "yt/geometry/oct_visitors.pyx":35
 *     index += oind(data)*data.dims
 *     for i in range(data.dims):
 *         p[1][data.index + i] = p[0][index + i]             # <<<<<<<<<<<<<<
 *     data.index += data.dims
 * 
 */
    ((__pyx_v_p[1])[(__pyx_v_data->index + __pyx_v_i)]) = ((__pyx_v_p[0])[(__pyx_v_index + __pyx_v_i)]);
  }

  /* "yt/geometry/oct_visitors.pyx":36
 *     for i in range(data.dims):
 *         p[1][data.index + i] = p[0][index + i]
 *     data.index += data.dims             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_data->index = (__pyx_v_data->index + __pyx_v_data->dims);
...
/* "yt/geometry/oct_visitors.pyx":38
 *     data.index += data.dims
 * 
 * cdef void copy_array_i64(Oct *o, OctVisitorData *data, np.uint8_t selected):             # <<<<<<<<<<<<<<
 *     # We should always have global_index less than our source.
...
static void __pyx_f_2yt_8geometry_12oct_visitors_copy_array_i64(CYTHON_UNUSED struct __pyx_t_2yt_8geometry_12oct_visitors_Oct *__pyx_v_o, struct __pyx_t_2yt_8geometry_12oct_visitors_OctVisitorData *__pyx_v_data, __pyx_t_5numpy_uint8_t __pyx_v_selected) {
  int __pyx_v_i;
  __pyx_t_5numpy_int64_t __pyx_v_index;
  ...
  int __pyx_t_2;
  int __pyx_t_3;
  __Pyx_RefNannySetupContext("copy_array_i64", 0);

  /* "yt/geometry/oct_visitors.pyx":41
 *     # We should always have global_index less than our source.
 *     # "last" here tells us the dimensionality of the array.
 *     if selected == 0: return             # <<<<<<<<<<<<<<
 *     cdef int i
 ...
 */
  ...
  /* "yt/geometry/oct_visitors.pyx":43
 *     if selected == 0: return
 *     cdef int i
 *     cdef np.int64_t index = (data.global_index * data.nz)*data.dims             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "yt/geometry/oct_visitors.pyx":44
 *     cdef int i
 *     cdef np.int64_t index = (data.global_index * data.nz)*data.dims
 *     cdef np.int64_t **p = <np.int64_t**> data.array             # <<<<<<<<<<<<<<
 *     index += oind(data)*data.dims
 *     for i in range(data.dims):
 */
  __pyx_v_p = ((__pyx_t_5numpy_int64_t **)__pyx_v_data->array);

  /* "yt/geometry/oct_visitors.pyx":45
 *     cdef np.int64_t index = (data.global_index * data.nz)*data.dims
 *     cdef np.int64_t **p = <np.int64_t**> data.array
 *     index += oind(data)*data.dims             # <<<<<<<<<<<<<<
 *     for i in range(data.dims):
 ...
 */
  ...
  /* "yt/geometry/oct_visitors.pyx":46
 *     cdef np.int64_t **p = <np.int64_t**> data.array
 *     index += oind(data)*data.dims
 *     for i in range(data.dims):             # <<<<<<<<<<<<<<
 *         p[1][data.index + i] = p[0][index + i]
 ...
 */
  ...
  for (__pyx_t_3 = 0; __pyx_t_3 < __pyx_t_2; __pyx_t_3+=1) {
    ...
    /* "yt/geometry/oct_visitors.pyx":47
 *     index += oind(data)*data.dims
 *     for i in range(data.dims):
 *         p[1][data.index + i] = p[0][index + i]             # <<<<<<<<<<<<<<
 *     data.index += data.dims
 ...
 */
  ...
  /* "yt/geometry/oct_visitors.pyx":48
 *     for i in range(data.dims):
 *         p[1][data.index + i] = p[0][index + i]
 *     data.index += data.dims             # <<<<<<<<<<<<<<
 * 
...
/* "yt/geometry/oct_visitors.pyx":50
 *     data.index += data.dims
 * 
 * cdef void count_total_octs(Oct *o, OctVisitorData *data, np.uint8_t selected):             # <<<<<<<<<<<<<<
...
static void __pyx_f_2yt_8geometry_12oct_visitors_count_total_octs(struct __pyx_t_2yt_8geometry_12oct_visitors_Oct *__pyx_v_o, struct __pyx_t_2yt_8geometry_12oct_visitors_OctVisitorData *__pyx_v_data, CYTHON_UNUSED __pyx_t_5numpy_uint8_t __pyx_v_selected) {
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  __pyx_t_5numpy_int64_t __pyx_t_2;
  __Pyx_RefNannySetupContext("count_total_octs", 0);

  /* "yt/geometry/oct_visitors.pyx":53
 *     # Count even if not selected.
 *     # Number of *octs* visited.
 ...
 */
  __pyx_t_1 = ((__pyx_v_data->last != __pyx_v_o->domain_ind) != 0);
  if (__pyx_t_1) {

    /* "yt/geometry/oct_visitors.pyx":54
 *     # Number of *octs* visited.
 *     if data.last != o.domain_ind:
 *         data.index += 1             # <<<<<<<<<<<<<<
 *         data.last = o.domain_ind
 ...
 */
    ...
    /* "yt/geometry/oct_visitors.pyx":55
 *     if data.last != o.domain_ind:
 *         data.index += 1
 *         data.last = o.domain_ind             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_t_2 = __pyx_v_o->domain_ind;
    __pyx_v_data->last = __pyx_t_2;
    goto __pyx_L3;
  }
  __pyx_L3:;
...
/* "yt/geometry/oct_visitors.pyx":57
 *         data.last = o.domain_ind
 * 
 * cdef void count_total_cells(Oct *o, OctVisitorData *data, np.uint8_t selected):             # <<<<<<<<<<<<<<
...
static void __pyx_f_2yt_8geometry_12oct_visitors_count_total_cells(CYTHON_UNUSED struct __pyx_t_2yt_8geometry_12oct_visitors_Oct *__pyx_v_o, struct __pyx_t_2yt_8geometry_12oct_visitors_OctVisitorData *__pyx_v_data, __pyx_t_5numpy_uint8_t __pyx_v_selected) {
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("count_total_cells", 0);

  /* "yt/geometry/oct_visitors.pyx":59
 * cdef void count_total_cells(Oct *o, OctVisitorData *data, np.uint8_t selected):
 *     # Number of *cells* visited and selected.
 *     data.index += selected             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_data->index = (__pyx_v_data->index + __pyx_v_selected);
...
/* "yt/geometry/oct_visitors.pyx":61
 *     data.index += selected
 * 
 * cdef void mark_octs(Oct *o, OctVisitorData *data, np.uint8_t selected):             # <<<<<<<<<<<<<<
...
static void __pyx_f_2yt_8geometry_12oct_visitors_mark_octs(struct __pyx_t_2yt_8geometry_12oct_visitors_Oct *__pyx_v_o, struct __pyx_t_2yt_8geometry_12oct_visitors_OctVisitorData *__pyx_v_data, CYTHON_UNUSED __pyx_t_5numpy_uint8_t __pyx_v_selected) {
  __pyx_t_5numpy_uint8_t *__pyx_v_arr;
  __pyx_t_5numpy_int64_t __pyx_v_index;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  __pyx_t_5numpy_int64_t __pyx_t_2;
  __Pyx_RefNannySetupContext("mark_octs", 0);

  /* "yt/geometry/oct_visitors.pyx":64
 *     # We mark them even if they are not selected
 *     cdef int i
 ...
 *         data.last = o.domain_ind
 */
  __pyx_v_arr = ((__pyx_t_5numpy_uint8_t *)__pyx_v_data->array);

  /* "yt/geometry/oct_visitors.pyx":65
 *     cdef int i
 *     cdef np.uint8_t *arr = <np.uint8_t *> data.array
 *     if data.last != o.domain_ind:             # <<<<<<<<<<<<<<
 *         data.last = o.domain_ind
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "yt/geometry/oct_visitors.pyx":66
 *     cdef np.uint8_t *arr = <np.uint8_t *> data.array
 *     if data.last != o.domain_ind:
 *         data.last = o.domain_ind             # <<<<<<<<<<<<<<
 *         data.index += 1
 ...
 */
    ...
    /* "yt/geometry/oct_visitors.pyx":67
 *     if data.last != o.domain_ind:
 *         data.last = o.domain_ind
 *         data.index += 1             # <<<<<<<<<<<<<<
 *     cdef np.int64_t index = data.index * data.nz
 ...
 */
  ...
  /* "yt/geometry/oct_visitors.pyx":68
 *         data.last = o.domain_ind
 *         data.index += 1
 *     cdef np.int64_t index = data.index * data.nz             # <<<<<<<<<<<<<<
 *     index += oind(data)
 *     arr[index] = 1
 */
  __pyx_v_index = (__pyx_v_data->index * __pyx_v_data->nz);

  /* "yt/geometry/oct_visitors.pyx":69
 *         data.index += 1
 *     cdef np.int64_t index = data.index * data.nz
 *     index += oind(data)             # <<<<<<<<<<<<<<
 *     arr[index] = 1
 * 
 */
  __pyx_v_index = (__pyx_v_index + __pyx_f_2yt_8geometry_12oct_visitors_oind(__pyx_v_data));

  /* "yt/geometry/oct_visitors.pyx":70
 *     cdef np.int64_t index = data.index * data.nz
 *     index += oind(data)
 *     arr[index] = 1             # <<<<<<<<<<<<<<
 * 
...
/* "yt/geometry/oct_visitors.pyx":72
 *     arr[index] = 1
 * 
 * cdef void mask_octs(Oct *o, OctVisitorData *data, np.uint8_t selected):             # <<<<<<<<<<<<<<
 *     if selected == 0: return
...
static void __pyx_f_2yt_8geometry_12oct_visitors_mask_octs(CYTHON_UNUSED struct __pyx_t_2yt_8geometry_12oct_visitors_Oct *__pyx_v_o, struct __pyx_t_2yt_8geometry_12oct_visitors_OctVisitorData *__pyx_v_data, __pyx_t_5numpy_uint8_t __pyx_v_selected) {
  __pyx_t_5numpy_uint8_t *__pyx_v_arr;
  __pyx_t_5numpy_int64_t __pyx_v_index;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  __Pyx_RefNannySetupContext("mask_octs", 0);

  /* "yt/geometry/oct_visitors.pyx":73
 * 
 * cdef void mask_octs(Oct *o, OctVisitorData *data, np.uint8_t selected):
 *     if selected == 0: return             # <<<<<<<<<<<<<<
 *     cdef int i
 ...
 */
  ...
  /* "yt/geometry/oct_visitors.pyx":75
 *     if selected == 0: return
 *     cdef int i
 *     cdef np.uint8_t *arr = <np.uint8_t *> data.array             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "yt/geometry/oct_visitors.pyx":76
 *     cdef int i
 *     cdef np.uint8_t *arr = <np.uint8_t *> data.array
 *     cdef np.int64_t index = data.global_index * data.nz             # <<<<<<<<<<<<<<
 *     index += oind(data)
 *     arr[index] = 1
 */
  __pyx_v_index = (__pyx_v_data->global_index * __pyx_v_data->nz);

  /* "yt/geometry/oct_visitors.pyx":77
 *     cdef np.uint8_t *arr = <np.uint8_t *> data.array
 *     cdef np.int64_t index = data.global_index * data.nz
 *     index += oind(data)             # <<<<<<<<<<<<<<
 *     arr[index] = 1
 ...
 */
  ...
  /* "yt/geometry/oct_visitors.pyx":78
 *     cdef np.int64_t index = data.global_index * data.nz
 *     index += oind(data)
 *     arr[index] = 1             # <<<<<<<<<<<<<<
 * 
...
/* "yt/geometry/oct_visitors.pyx":80
 *     arr[index] = 1
 * 
 * cdef void index_octs(Oct *o, OctVisitorData *data, np.uint8_t selected):             # <<<<<<<<<<<<<<
...
static void __pyx_f_2yt_8geometry_12oct_visitors_index_octs(struct __pyx_t_2yt_8geometry_12oct_visitors_Oct *__pyx_v_o, struct __pyx_t_2yt_8geometry_12oct_visitors_OctVisitorData *__pyx_v_data, CYTHON_UNUSED __pyx_t_5numpy_uint8_t __pyx_v_selected) {
  __pyx_t_5numpy_int64_t *__pyx_v_arr;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  __pyx_t_5numpy_int64_t __pyx_t_2;
  __pyx_t_5numpy_uint64_t __pyx_t_3;
  __Pyx_RefNannySetupContext("index_octs", 0);

  /* "yt/geometry/oct_visitors.pyx":84
 *     cdef int i
 *     cdef np.int64_t *arr
 *     if data.last != o.domain_ind:             # <<<<<<<<<<<<<<
 *         data.last = o.domain_ind
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "yt/geometry/oct_visitors.pyx":85
 *     cdef np.int64_t *arr
 *     if data.last != o.domain_ind:
 *         data.last = o.domain_ind             # <<<<<<<<<<<<<<
 *         arr = <np.int64_t *> data.array
 ...
 */
    ...
    /* "yt/geometry/oct_visitors.pyx":86
 *     if data.last != o.domain_ind:
 *         data.last = o.domain_ind
 *         arr = <np.int64_t *> data.array             # <<<<<<<<<<<<<<
 *         arr[o.domain_ind] = data.index
 *         data.index += 1
 */
    __pyx_v_arr = ((__pyx_t_5numpy_int64_t *)__pyx_v_data->array);

    /* "yt/geometry/oct_visitors.pyx":87
 *         data.last = o.domain_ind
 *         arr = <np.int64_t *> data.array
 *         arr[o.domain_ind] = data.index             # <<<<<<<<<<<<<<
 *         data.index += 1
 * 
 */
    __pyx_t_3 = __pyx_v_data->index;
    (__pyx_v_arr[__pyx_v_o->domain_ind]) = __pyx_t_3;

    /* "yt/geometry/oct_visitors.pyx":88
 *         arr = <np.int64_t *> data.array
 *         arr[o.domain_ind] = data.index
 *         data.index += 1             # <<<<<<<<<<<<<<
 * 
...
/* "yt/geometry/oct_visitors.pyx":90
 *         data.index += 1
 * 
 * cdef void icoords_octs(Oct *o, OctVisitorData *data, np.uint8_t selected):             # <<<<<<<<<<<<<<
 *     if selected == 0: return
...
static void __pyx_f_2yt_8geometry_12oct_visitors_icoords_octs(CYTHON_UNUSED struct __pyx_t_2yt_8geometry_12oct_visitors_Oct *__pyx_v_o, struct __pyx_t_2yt_8geometry_12oct_visitors_OctVisitorData *__pyx_v_data, __pyx_t_5numpy_uint8_t __pyx_v_selected) {
  __pyx_t_5numpy_int64_t *__pyx_v_coords;
  int __pyx_v_i;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  int __pyx_t_2;
  __Pyx_RefNannySetupContext("icoords_octs", 0);

  /* "yt/geometry/oct_visitors.pyx":91
 * 
 * cdef void icoords_octs(Oct *o, OctVisitorData *data, np.uint8_t selected):
 *     if selected == 0: return             # <<<<<<<<<<<<<<
 *     cdef np.int64_t *coords = <np.int64_t*> data.array
 ...
 */
  ...
  /* "yt/geometry/oct_visitors.pyx":92
 * cdef void icoords_octs(Oct *o, OctVisitorData *data, np.uint8_t selected):
 *     if selected == 0: return
 *     cdef np.int64_t *coords = <np.int64_t*> data.array             # <<<<<<<<<<<<<<
 *     cdef int i
 *     for i in range(3):
 */
  __pyx_v_coords = ((__pyx_t_5numpy_int64_t *)__pyx_v_data->array);

  /* "yt/geometry/oct_visitors.pyx":94
 *     cdef np.int64_t *coords = <np.int64_t*> data.array
 *     cdef int i
 *     for i in range(3):             # <<<<<<<<<<<<<<
 ...
 */
  for (__pyx_t_2 = 0; __pyx_t_2 < 3; __pyx_t_2+=1) {
    ...
    /* "yt/geometry/oct_visitors.pyx":95
 *     cdef int i
 *     for i in range(3):
 *         coords[data.index * 3 + i] = (data.pos[i] << data.oref) + data.ind[i]             # <<<<<<<<<<<<<<
 *     data.index += 1
 * 
 */
    (__pyx_v_coords[((__pyx_v_data->index * 3) + __pyx_v_i)]) = (((__pyx_v_data->pos[__pyx_v_i]) << __pyx_v_data->oref) + (__pyx_v_data->ind[__pyx_v_i]));
  }

  /* "yt/geometry/oct_visitors.pyx":96
 *     for i in range(3):
 *         coords[data.index * 3 + i] = (data.pos[i] << data.oref) + data.ind[i]
 *     data.index += 1             # <<<<<<<<<<<<<<
 * 
...
/* "yt/geometry/oct_visitors.pyx":98
 *     data.index += 1
 * 
 * cdef void ires_octs(Oct *o, OctVisitorData *data, np.uint8_t selected):             # <<<<<<<<<<<<<<
 *     if selected == 0: return
...
static void __pyx_f_2yt_8geometry_12oct_visitors_ires_octs(CYTHON_UNUSED struct __pyx_t_2yt_8geometry_12oct_visitors_Oct *__pyx_v_o, struct __pyx_t_2yt_8geometry_12oct_visitors_OctVisitorData *__pyx_v_data, __pyx_t_5numpy_uint8_t __pyx_v_selected) {
  __pyx_t_5numpy_int64_t *__pyx_v_ires;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  __pyx_t_5numpy_int8_t __pyx_t_2;
  __Pyx_RefNannySetupContext("ires_octs", 0);

  /* "yt/geometry/oct_visitors.pyx":99
 * 
 * cdef void ires_octs(Oct *o, OctVisitorData *data, np.uint8_t selected):
 *     if selected == 0: return             # <<<<<<<<<<<<<<
 *     cdef np.int64_t *ires = <np.int64_t*> data.array
 ...
 */
  ...
  /* "yt/geometry/oct_visitors.pyx":100
 * cdef void ires_octs(Oct *o, OctVisitorData *data, np.uint8_t selected):
 *     if selected == 0: return
 *     cdef np.int64_t *ires = <np.int64_t*> data.array             # <<<<<<<<<<<<<<
 *     ires[data.index] = data.level
 ...
 */
  ...
  /* "yt/geometry/oct_visitors.pyx":101
 *     if selected == 0: return
 *     cdef np.int64_t *ires = <np.int64_t*> data.array
 *     ires[data.index] = data.level             # <<<<<<<<<<<<<<
 *     data.index += 1
 * 
 */
  __pyx_t_2 = __pyx_v_data->level;
  (__pyx_v_ires[__pyx_v_data->index]) = __pyx_t_2;

  /* "yt/geometry/oct_visitors.pyx":102
 *     cdef np.int64_t *ires = <np.int64_t*> data.array
 *     ires[data.index] = data.level
 *     data.index += 1             # <<<<<<<<<<<<<<
 * 
...
/* "yt/geometry/oct_visitors.pyx":105
 * 
 * @cython.cdivision(True)
...
static void __pyx_f_2yt_8geometry_12oct_visitors_fcoords_octs(CYTHON_UNUSED struct __pyx_t_2yt_8geometry_12oct_visitors_Oct *__pyx_v_o, struct __pyx_t_2yt_8geometry_12oct_visitors_OctVisitorData *__pyx_v_data, __pyx_t_5numpy_uint8_t __pyx_v_selected) {
  ...
  int __pyx_t_1;
  int __pyx_t_2;
  __Pyx_RefNannySetupContext("fcoords_octs", 0);

  /* "yt/geometry/oct_visitors.pyx":109
 *     # coordinates.  It gives them in some unit system where the domain is 1.0
 ...
 */
  ...
  /* "yt/geometry/oct_visitors.pyx":110
 *     # in all directions, and assumes that they will be scaled later.
 *     if selected == 0: return
 *     cdef np.float64_t *fcoords = <np.float64_t*> data.array             # <<<<<<<<<<<<<<
 *     cdef int i
 ...
 */
  ...
  /* "yt/geometry/oct_visitors.pyx":113
 *     cdef int i
 *     cdef np.float64_t c, dx
 ...
 */
  __pyx_v_dx = (1.0 / ((1 << __pyx_v_data->oref) << __pyx_v_data->level));

  /* "yt/geometry/oct_visitors.pyx":114
 *     cdef np.float64_t c, dx
 *     dx = 1.0 / ((1 << data.oref) << data.level)
 *     for i in range(3):             # <<<<<<<<<<<<<<
 *         c = <np.float64_t> ((data.pos[i] << data.oref ) + data.ind[i])
 ...
 */
  for (__pyx_t_2 = 0; __pyx_t_2 < 3; __pyx_t_2+=1) {
    ...
    /* "yt/geometry/oct_visitors.pyx":115
 *     dx = 1.0 / ((1 << data.oref) << data.level)
 *     for i in range(3):
 *         c = <np.float64_t> ((data.pos[i] << data.oref ) + data.ind[i])             # <<<<<<<<<<<<<<
 *         fcoords[data.index * 3 + i] = (c + 0.5) * dx
 *     data.index += 1
 */
    __pyx_v_c = ((__pyx_t_5numpy_float64_t)(((__pyx_v_data->pos[__pyx_v_i]) << __pyx_v_data->oref) + (__pyx_v_data->ind[__pyx_v_i])));

    /* "yt/geometry/oct_visitors.pyx":116
 *     for i in range(3):
 *         c = <np.float64_t> ((data.pos[i] << data.oref ) + data.ind[i])
 *         fcoords[data.index * 3 + i] = (c + 0.5) * dx             # <<<<<<<<<<<<<<
 *     data.index += 1
 * 
 */
    (__pyx_v_fcoords[((__pyx_v_data->index * 3) + __pyx_v_i)]) = ((__pyx_v_c + 0.5) * __pyx_v_dx);
  }

  /* "yt/geometry/oct_visitors.pyx":117
 *         c = <np.float64_t> ((data.pos[i] << data.oref ) + data.ind[i])
 *         fcoords[data.index * 3 + i] = (c + 0.5) * dx
 *     data.index += 1             # <<<<<<<<<<<<<<
 * 
...
/* "yt/geometry/oct_visitors.pyx":120
 * 
 * @cython.cdivision(True)
...
static void __pyx_f_2yt_8geometry_12oct_visitors_fwidth_octs(CYTHON_UNUSED struct __pyx_t_2yt_8geometry_12oct_visitors_Oct *__pyx_v_o, struct __pyx_t_2yt_8geometry_12oct_visitors_OctVisitorData *__pyx_v_data, __pyx_t_5numpy_uint8_t __pyx_v_selected) {
  ...
  int __pyx_t_1;
  int __pyx_t_2;
  __Pyx_RefNannySetupContext("fwidth_octs", 0);

  /* "yt/geometry/oct_visitors.pyx":124
 *     # coordinates.  It gives them in some unit system where the domain is 1.0
 *     # in all directions, and assumes that they will be scaled later.
 *     if selected == 0: return             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "yt/geometry/oct_visitors.pyx":125
 *     # in all directions, and assumes that they will be scaled later.
 *     if selected == 0: return
 *     cdef np.float64_t *fwidth = <np.float64_t*> data.array             # <<<<<<<<<<<<<<
 *     cdef int i
 ...
 */
  ...
  /* "yt/geometry/oct_visitors.pyx":128
 *     cdef int i
 *     cdef np.float64_t dx
 *     dx = 1.0 / ((1 << data.oref) << data.level)             # <<<<<<<<<<<<<<
 *     for i in range(3):
 ...
 */
  ...
  /* "yt/geometry/oct_visitors.pyx":129
 *     cdef np.float64_t dx
 *     dx = 1.0 / ((1 << data.oref) << data.level)
 *     for i in range(3):             # <<<<<<<<<<<<<<
 *         fwidth[data.index * 3 + i] = dx
 ...
 */
  for (__pyx_t_2 = 0; __pyx_t_2 < 3; __pyx_t_2+=1) {
    ...
    /* "yt/geometry/oct_visitors.pyx":130
 *     dx = 1.0 / ((1 << data.oref) << data.level)
 *     for i in range(3):
 *         fwidth[data.index * 3 + i] = dx             # <<<<<<<<<<<<<<
 *     data.index += 1
 * 
 */
    (__pyx_v_fwidth[((__pyx_v_data->index * 3) + __pyx_v_i)]) = __pyx_v_dx;
  }

  /* "yt/geometry/oct_visitors.pyx":131
 *     for i in range(3):
 *         fwidth[data.index * 3 + i] = dx
 *     data.index += 1             # <<<<<<<<<<<<<<
 * 
...
/* "yt/geometry/oct_visitors.pyx":133
 *     data.index += 1
 * 
 * cdef void identify_octs(Oct *o, OctVisitorData *data, np.uint8_t selected):             # <<<<<<<<<<<<<<
...
static void __pyx_f_2yt_8geometry_12oct_visitors_identify_octs(struct __pyx_t_2yt_8geometry_12oct_visitors_Oct *__pyx_v_o, struct __pyx_t_2yt_8geometry_12oct_visitors_OctVisitorData *__pyx_v_data, __pyx_t_5numpy_uint8_t __pyx_v_selected) {
  __pyx_t_5numpy_uint8_t *__pyx_v_arr;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  __Pyx_RefNannySetupContext("identify_octs", 0);

  /* "yt/geometry/oct_visitors.pyx":137
 *     # we'll get all cells within the domain for a by-domain selector and all
 ...
 */
  ...
  /* "yt/geometry/oct_visitors.pyx":138
 *     # cells within the domain *and* selector for the selector itself.
 *     if selected == 0: return
 *     cdef np.uint8_t *arr = <np.uint8_t *> data.array             # <<<<<<<<<<<<<<
 *     arr[o.domain - 1] = 1
 ...
 */
  ...
  /* "yt/geometry/oct_visitors.pyx":139
 *     if selected == 0: return
 *     cdef np.uint8_t *arr = <np.uint8_t *> data.array
 *     arr[o.domain - 1] = 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  (__pyx_v_arr[(__pyx_v_o->domain - 1)]) = 1;
...
/* "yt/geometry/oct_visitors.pyx":141
 *     arr[o.domain - 1] = 1
 * 
 * cdef void assign_domain_ind(Oct *o, OctVisitorData *data, np.uint8_t selected):             # <<<<<<<<<<<<<<
...
static void __pyx_f_2yt_8geometry_12oct_visitors_assign_domain_ind(struct __pyx_t_2yt_8geometry_12oct_visitors_Oct *__pyx_v_o, struct __pyx_t_2yt_8geometry_12oct_visitors_OctVisitorData *__pyx_v_data, CYTHON_UNUSED __pyx_t_5numpy_uint8_t __pyx_v_selected) {
  __Pyx_RefNannyDeclarations
  __pyx_t_5numpy_int64_t __pyx_t_1;
  __Pyx_RefNannySetupContext("assign_domain_ind", 0);

  /* "yt/geometry/oct_visitors.pyx":142
 * 
 * cdef void assign_domain_ind(Oct *o, OctVisitorData *data, np.uint8_t selected):
 *     o.domain_ind = data.global_index             # <<<<<<<<<<<<<<
 *     data.index += 1
 * 
 */
  __pyx_t_1 = __pyx_v_data->global_index;
  __pyx_v_o->domain_ind = __pyx_t_1;

  /* "yt/geometry/oct_visitors.pyx":143
 * cdef void assign_domain_ind(Oct *o, OctVisitorData *data, np.uint8_t selected):
 *     o.domain_ind = data.global_index
 *     data.index += 1             # <<<<<<<<<<<<<<
 * 
...
/* "yt/geometry/oct_visitors.pyx":145
 *     data.index += 1
 * 
 * cdef void fill_file_indices_oind(Oct *o, OctVisitorData *data, np.uint8_t selected):             # <<<<<<<<<<<<<<
...
static void __pyx_f_2yt_8geometry_12oct_visitors_fill_file_indices_oind(struct __pyx_t_2yt_8geometry_12oct_visitors_Oct *__pyx_v_o, struct __pyx_t_2yt_8geometry_12oct_visitors_OctVisitorData *__pyx_v_data, __pyx_t_5numpy_uint8_t __pyx_v_selected) {
  void **__pyx_v_p;
  __pyx_t_5numpy_uint8_t *__pyx_v_level_arr;
  __pyx_t_5numpy_int64_t *__pyx_v_find_arr;
  __pyx_t_5numpy_uint8_t *__pyx_v_cell_arr;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  __pyx_t_5numpy_int8_t __pyx_t_2;
  __pyx_t_5numpy_int64_t __pyx_t_3;
  __Pyx_RefNannySetupContext("fill_file_indices_oind", 0);

  /* "yt/geometry/oct_visitors.pyx":148
 *     # We fill these arrays, then inside the level filler we use these as
 *     # indices as we fill a second array from the data.
 *     if selected == 0: return             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "yt/geometry/oct_visitors.pyx":149
 *     # indices as we fill a second array from the data.
 *     if selected == 0: return
 *     cdef void **p = <void **> data.array             # <<<<<<<<<<<<<<
 *     cdef np.uint8_t *level_arr = <np.uint8_t *> p[0]
 ...
 */
  __pyx_v_p = ((void **)__pyx_v_data->array);

  /* "yt/geometry/oct_visitors.pyx":150
 *     if selected == 0: return
 *     cdef void **p = <void **> data.array
 *     cdef np.uint8_t *level_arr = <np.uint8_t *> p[0]             # <<<<<<<<<<<<<<
 *     cdef np.int64_t *find_arr = <np.int64_t *> p[1]
 ...
 */
  __pyx_v_level_arr = ((__pyx_t_5numpy_uint8_t *)(__pyx_v_p[0]));

  /* "yt/geometry/oct_visitors.pyx":151
 *     cdef void **p = <void **> data.array
 *     cdef np.uint8_t *level_arr = <np.uint8_t *> p[0]
 *     cdef np.int64_t *find_arr = <np.int64_t *> p[1]             # <<<<<<<<<<<<<<
 *     cdef np.uint8_t *cell_arr = <np.uint8_t *> p[2]
 ...
 */
  __pyx_v_find_arr = ((__pyx_t_5numpy_int64_t *)(__pyx_v_p[1]));

  /* "yt/geometry/oct_visitors.pyx":152
 *     cdef np.uint8_t *level_arr = <np.uint8_t *> p[0]
 *     cdef np.int64_t *find_arr = <np.int64_t *> p[1]
 *     cdef np.uint8_t *cell_arr = <np.uint8_t *> p[2]             # <<<<<<<<<<<<<<
 *     level_arr[data.index] = data.level
 ...
 */
  __pyx_v_cell_arr = ((__pyx_t_5numpy_uint8_t *)(__pyx_v_p[2]));

  /* "yt/geometry/oct_visitors.pyx":153
 *     cdef np.int64_t *find_arr = <np.int64_t *> p[1]
 *     cdef np.uint8_t *cell_arr = <np.uint8_t *> p[2]
 *     level_arr[data.index] = data.level             # <<<<<<<<<<<<<<
 *     find_arr[data.index] = o.file_ind
 ...
 */
  __pyx_t_2 = __pyx_v_data->level;
  (__pyx_v_level_arr[__pyx_v_data->index]) = __pyx_t_2;

  /* "yt/geometry/oct_visitors.pyx":154
 *     cdef np.uint8_t *cell_arr = <np.uint8_t *> p[2]
 *     level_arr[data.index] = data.level
 *     find_arr[data.index] = o.file_ind             # <<<<<<<<<<<<<<
 *     cell_arr[data.index] = oind(data)
 *     data.index +=1
 */
  __pyx_t_3 = __pyx_v_o->file_ind;
  (__pyx_v_find_arr[__pyx_v_data->index]) = __pyx_t_3;

  /* "yt/geometry/oct_visitors.pyx":155
 *     level_arr[data.index] = data.level
 *     find_arr[data.index] = o.file_ind
 *     cell_arr[data.index] = oind(data)             # <<<<<<<<<<<<<<
 *     data.index +=1
 * 
 */
  (__pyx_v_cell_arr[__pyx_v_data->index]) = __pyx_f_2yt_8geometry_12oct_visitors_oind(__pyx_v_data);

  /* "yt/geometry/oct_visitors.pyx":156
 *     find_arr[data.index] = o.file_ind
 *     cell_arr[data.index] = oind(data)
 *     data.index +=1             # <<<<<<<<<<<<<<
 * 
...
/* "yt/geometry/oct_visitors.pyx":158
 *     data.index +=1
 * 
 * cdef void fill_file_indices_rind(Oct *o, OctVisitorData *data, np.uint8_t selected):             # <<<<<<<<<<<<<<
 *     # We fill these arrays, then inside the level filler we use these as
...
static void __pyx_f_2yt_8geometry_12oct_visitors_fill_file_indices_rind(struct __pyx_t_2yt_8geometry_12oct_visitors_Oct *__pyx_v_o, struct __pyx_t_2yt_8geometry_12oct_visitors_OctVisitorData *__pyx_v_data, __pyx_t_5numpy_uint8_t __pyx_v_selected) {
  void **__pyx_v_p;
  __pyx_t_5numpy_uint8_t *__pyx_v_level_arr;
  __pyx_t_5numpy_int64_t *__pyx_v_find_arr;
  __pyx_t_5numpy_uint8_t *__pyx_v_cell_arr;
  ...
  __pyx_t_5numpy_int8_t __pyx_t_2;
  __pyx_t_5numpy_int64_t __pyx_t_3;
  __Pyx_RefNannySetupContext("fill_file_indices_rind", 0);

  /* "yt/geometry/oct_visitors.pyx":161
 *     # We fill these arrays, then inside the level filler we use these as
 *     # indices as we fill a second array from the data.
 *     if selected == 0: return             # <<<<<<<<<<<<<<
 *     cdef void **p = <void **> data.array
 ...
 */
  ...
  /* "yt/geometry/oct_visitors.pyx":162
 *     # indices as we fill a second array from the data.
 *     if selected == 0: return
 *     cdef void **p = <void **> data.array             # <<<<<<<<<<<<<<
 *     cdef np.uint8_t *level_arr = <np.uint8_t *> p[0]
 ...
 */
  ...
  /* "yt/geometry/oct_visitors.pyx":163
 *     if selected == 0: return
 *     cdef void **p = <void **> data.array
 *     cdef np.uint8_t *level_arr = <np.uint8_t *> p[0]             # <<<<<<<<<<<<<<
 *     cdef np.int64_t *find_arr = <np.int64_t *> p[1]
 ...
 */
  ...
  /* "yt/geometry/oct_visitors.pyx":164
 *     cdef void **p = <void **> data.array
 *     cdef np.uint8_t *level_arr = <np.uint8_t *> p[0]
 *     cdef np.int64_t *find_arr = <np.int64_t *> p[1]             # <<<<<<<<<<<<<<
 *     cdef np.uint8_t *cell_arr = <np.uint8_t *> p[2]
 ...
 */
  ...
  /* "yt/geometry/oct_visitors.pyx":165
 *     cdef np.uint8_t *level_arr = <np.uint8_t *> p[0]
 *     cdef np.int64_t *find_arr = <np.int64_t *> p[1]
 *     cdef np.uint8_t *cell_arr = <np.uint8_t *> p[2]             # <<<<<<<<<<<<<<
 *     level_arr[data.index] = data.level
 ...
 */
  ...
  /* "yt/geometry/oct_visitors.pyx":166
 *     cdef np.int64_t *find_arr = <np.int64_t *> p[1]
 *     cdef np.uint8_t *cell_arr = <np.uint8_t *> p[2]
 *     level_arr[data.index] = data.level             # <<<<<<<<<<<<<<
 *     find_arr[data.index] = o.file_ind
 ...
 */
  ...
  /* "yt/geometry/oct_visitors.pyx":167
 *     cdef np.uint8_t *cell_arr = <np.uint8_t *> p[2]
 *     level_arr[data.index] = data.level
 *     find_arr[data.index] = o.file_ind             # <<<<<<<<<<<<<<
 *     cell_arr[data.index] = rind(data)
 ...
 */
  ...
  /* "yt/geometry/oct_visitors.pyx":168
 *     level_arr[data.index] = data.level
 *     find_arr[data.index] = o.file_ind
 *     cell_arr[data.index] = rind(data)             # <<<<<<<<<<<<<<
 *     data.index +=1
 * 
 */
  (__pyx_v_cell_arr[__pyx_v_data->index]) = __pyx_f_2yt_8geometry_12oct_visitors_rind(__pyx_v_data);

  /* "yt/geometry/oct_visitors.pyx":169
 *     find_arr[data.index] = o.file_ind
 *     cell_arr[data.index] = rind(data)
 *     data.index +=1             # <<<<<<<<<<<<<<
 * 
...
/* "yt/geometry/oct_visitors.pyx":171
 *     data.index +=1
 * 
 * cdef void count_by_domain(Oct *o, OctVisitorData *data, np.uint8_t selected):             # <<<<<<<<<<<<<<
 *     cdef np.int64_t *arr
...
static void __pyx_f_2yt_8geometry_12oct_visitors_count_by_domain(struct __pyx_t_2yt_8geometry_12oct_visitors_Oct *__pyx_v_o, struct __pyx_t_2yt_8geometry_12oct_visitors_OctVisitorData *__pyx_v_data, __pyx_t_5numpy_uint8_t __pyx_v_selected) {
  __pyx_t_5numpy_int64_t *__pyx_v_arr;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  __pyx_t_5numpy_int64_t __pyx_t_2;
  __Pyx_RefNannySetupContext("count_by_domain", 0);

  /* "yt/geometry/oct_visitors.pyx":173
 * cdef void count_by_domain(Oct *o, OctVisitorData *data, np.uint8_t selected):
 *     cdef np.int64_t *arr
 *     if selected == 0: return             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "yt/geometry/oct_visitors.pyx":175
 *     if selected == 0: return
 *     # NOTE: We do this for every *cell*.
 *     arr = <np.int64_t *> data.array             # <<<<<<<<<<<<<<
 *     arr[o.domain - 1] += 1
 ...
 */
  ...
  /* "yt/geometry/oct_visitors.pyx":176
 *     # NOTE: We do this for every *cell*.
 *     arr = <np.int64_t *> data.array
 *     arr[o.domain - 1] += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_t_2 = (__pyx_v_o->domain - 1);
  (__pyx_v_arr[__pyx_t_2]) = ((__pyx_v_arr[__pyx_t_2]) + 1);
...
/* "yt/geometry/oct_visitors.pyx":178
 *     arr[o.domain - 1] += 1
 * 
 * cdef void store_octree(Oct *o, OctVisitorData *data, np.uint8_t selected):             # <<<<<<<<<<<<<<
...
static void __pyx_f_2yt_8geometry_12oct_visitors_store_octree(struct __pyx_t_2yt_8geometry_12oct_visitors_Oct *__pyx_v_o, struct __pyx_t_2yt_8geometry_12oct_visitors_OctVisitorData *__pyx_v_data, CYTHON_UNUSED __pyx_t_5numpy_uint8_t __pyx_v_selected) {
  __pyx_t_5numpy_uint8_t *__pyx_v_arr;
  __pyx_t_5numpy_uint8_t __pyx_v_res;
  CYTHON_UNUSED __pyx_t_5numpy_uint8_t __pyx_v_ii;
  void **__pyx_v_p;
  __Pyx_RefNannyDeclarations
  int __pyx_t_1;
  __Pyx_RefNannySetupContext("store_octree", 0);

  /* "yt/geometry/oct_visitors.pyx":180
 * cdef void store_octree(Oct *o, OctVisitorData *data, np.uint8_t selected):
 *     cdef np.uint8_t *arr, res, ii, *always_descend
 *     ii = cind(data.ind[0], data.ind[1], data.ind[2])             # <<<<<<<<<<<<<<
 *     cdef void **p = <void **> data.array
 *     arr = <np.uint8_t *> p[0]
 */
  __pyx_v_ii = __pyx_f_2yt_8geometry_12oct_visitors_cind((__pyx_v_data->ind[0]), (__pyx_v_data->ind[1]), (__pyx_v_data->ind[2]));

  /* "yt/geometry/oct_visitors.pyx":181
 *     cdef np.uint8_t *arr, res, ii, *always_descend
 *     ii = cind(data.ind[0], data.ind[1], data.ind[2])
 *     cdef void **p = <void **> data.array             # <<<<<<<<<<<<<<
 *     arr = <np.uint8_t *> p[0]
 ...
 */
  ...
  /* "yt/geometry/oct_visitors.pyx":182
 *     ii = cind(data.ind[0], data.ind[1], data.ind[2])
 *     cdef void **p = <void **> data.array
 *     arr = <np.uint8_t *> p[0]             # <<<<<<<<<<<<<<
 *     if o.children == NULL:
 *         # Not refined.
 */
  __pyx_v_arr = ((__pyx_t_5numpy_uint8_t *)(__pyx_v_p[0]));

  /* "yt/geometry/oct_visitors.pyx":183
 *     cdef void **p = <void **> data.array
 *     arr = <np.uint8_t *> p[0]
 *     if o.children == NULL:             # <<<<<<<<<<<<<<
 *         # Not refined.
 *         res = 0
 */
  __pyx_t_1 = ((__pyx_v_o->children == NULL) != 0);
  if (__pyx_t_1) {

    /* "yt/geometry/oct_visitors.pyx":185
 *     if o.children == NULL:
 *         # Not refined.
 *         res = 0             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /*else*/ {
    ...
    /* "yt/geometry/oct_visitors.pyx":187
 *         res = 0
 *     else:
 *         res = 1             # <<<<<<<<<<<<<<
 *     arr[data.index] = res
 ...
 */
  ...
  /* "yt/geometry/oct_visitors.pyx":188
 *     else:
 *         res = 1
 *     arr[data.index] = res             # <<<<<<<<<<<<<<
 *     data.index += 1
 * 
 */
  (__pyx_v_arr[__pyx_v_data->index]) = __pyx_v_res;

  /* "yt/geometry/oct_visitors.pyx":189
 *         res = 1
 *     arr[data.index] = res
 *     data.index += 1             # <<<<<<<<<<<<<<
 * 
...
/* "yt/geometry/oct_visitors.pyx":191
 *     data.index += 1
 * 
 * cdef void load_octree(Oct *o, OctVisitorData *data, np.uint8_t selected):             # <<<<<<<<<<<<<<
 *     cdef void **p = <void **> data.array
...
static void __pyx_f_2yt_8geometry_12oct_visitors_load_octree(struct __pyx_t_2yt_8geometry_12oct_visitors_Oct *__pyx_v_o, struct __pyx_t_2yt_8geometry_12oct_visitors_OctVisitorData *__pyx_v_data, CYTHON_UNUSED __pyx_t_5numpy_uint8_t __pyx_v_selected) {
  void **__pyx_v_p;
  __pyx_t_5numpy_uint8_t *__pyx_v_arr;
  struct __pyx_t_2yt_8geometry_12oct_visitors_Oct *__pyx_v_octs;
  __pyx_t_5numpy_int64_t *__pyx_v_nocts;
  ...
  /* "yt/geometry/oct_visitors.pyx":192
 * 
 * cdef void load_octree(Oct *o, OctVisitorData *data, np.uint8_t selected):
 *     cdef void **p = <void **> data.array             # <<<<<<<<<<<<<<
 *     cdef np.uint8_t *arr = <np.uint8_t *> p[0]
 ...
 */
  ...
  /* "yt/geometry/oct_visitors.pyx":193
 * cdef void load_octree(Oct *o, OctVisitorData *data, np.uint8_t selected):
 *     cdef void **p = <void **> data.array
 *     cdef np.uint8_t *arr = <np.uint8_t *> p[0]             # <<<<<<<<<<<<<<
 *     cdef Oct* octs = <Oct*> p[1]
 ...
 */
  ...
  /* "yt/geometry/oct_visitors.pyx":194
 *     cdef void **p = <void **> data.array
 *     cdef np.uint8_t *arr = <np.uint8_t *> p[0]
 *     cdef Oct* octs = <Oct*> p[1]             # <<<<<<<<<<<<<<
 *     cdef np.int64_t *nocts = <np.int64_t*> p[2]
 ...
 */
  __pyx_v_octs = ((struct __pyx_t_2yt_8geometry_12oct_visitors_Oct *)(__pyx_v_p[1]));

  /* "yt/geometry/oct_visitors.pyx":195
 *     cdef np.uint8_t *arr = <np.uint8_t *> p[0]
 *     cdef Oct* octs = <Oct*> p[1]
 *     cdef np.int64_t *nocts = <np.int64_t*> p[2]             # <<<<<<<<<<<<<<
 *     cdef np.int64_t *nfinest = <np.int64_t*> p[3]
 *     cdef int i, ii
 */
  __pyx_v_nocts = ((__pyx_t_5numpy_int64_t *)(__pyx_v_p[2]));

  /* "yt/geometry/oct_visitors.pyx":196
 *     cdef Oct* octs = <Oct*> p[1]
 *     cdef np.int64_t *nocts = <np.int64_t*> p[2]
 *     cdef np.int64_t *nfinest = <np.int64_t*> p[3]             # <<<<<<<<<<<<<<
 *     cdef int i, ii
 *     ii = cind(data.ind[0], data.ind[1], data.ind[2])
 */
  __pyx_v_nfinest = ((__pyx_t_5numpy_int64_t *)(__pyx_v_p[3]));

  /* "yt/geometry/oct_visitors.pyx":198
 *     cdef np.int64_t *nfinest = <np.int64_t*> p[3]
 *     cdef int i, ii
 *     ii = cind(data.ind[0], data.ind[1], data.ind[2])             # <<<<<<<<<<<<<<
 *     if arr[data.index] == 0:
 ...
 */
  ...
  /* "yt/geometry/oct_visitors.pyx":199
 *     cdef int i, ii
 *     ii = cind(data.ind[0], data.ind[1], data.ind[2])
 *     if arr[data.index] == 0:             # <<<<<<<<<<<<<<
 *         # We only want to do this once.  Otherwise we end up with way too many
 ...
 */
  __pyx_t_1 = (((__pyx_v_arr[__pyx_v_data->index]) == 0) != 0);
  if (__pyx_t_1) {

    /* "yt/geometry/oct_visitors.pyx":202
 *         # We only want to do this once.  Otherwise we end up with way too many
 *         # nfinest for our tastes.
 *         if o.file_ind == -1:             # <<<<<<<<<<<<<<
 *             o.children = NULL
 ...
 */
    __pyx_t_1 = ((__pyx_v_o->file_ind == -1) != 0);
    if (__pyx_t_1) {

      /* "yt/geometry/oct_visitors.pyx":203
 *         # nfinest for our tastes.
 *         if o.file_ind == -1:
 *             o.children = NULL             # <<<<<<<<<<<<<<
 *             o.file_ind = nfinest[0]
 *             o.domain = 1
 */
      __pyx_v_o->children = NULL;

      /* "yt/geometry/oct_visitors.pyx":204
 *         if o.file_ind == -1:
 *             o.children = NULL
 *             o.file_ind = nfinest[0]             # <<<<<<<<<<<<<<
 *             o.domain = 1
 *             nfinest[0] += 1
 */
      __pyx_v_o->file_ind = (__pyx_v_nfinest[0]);

      /* "yt/geometry/oct_visitors.pyx":205
 *             o.children = NULL
 *             o.file_ind = nfinest[0]
 *             o.domain = 1             # <<<<<<<<<<<<<<
 *             nfinest[0] += 1
 ...
 */
      ...
      /* "yt/geometry/oct_visitors.pyx":206
 *             o.file_ind = nfinest[0]
 *             o.domain = 1
 *             nfinest[0] += 1             # <<<<<<<<<<<<<<
 *     elif arr[data.index] > 0:
 ...
 */
      __pyx_t_2 = 0;
      (__pyx_v_nfinest[__pyx_t_2]) = ((__pyx_v_nfinest[__pyx_t_2]) + 1);
      goto __pyx_L4;
    }
    __pyx_L4:;
    goto __pyx_L3;
  ...
  /* "yt/geometry/oct_visitors.pyx":207
 *             o.domain = 1
 *             nfinest[0] += 1
 *     elif arr[data.index] > 0:             # <<<<<<<<<<<<<<
 *         if arr[data.index] != 1 and arr[data.index] != 8:
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "yt/geometry/oct_visitors.pyx":208
 *             nfinest[0] += 1
 *     elif arr[data.index] > 0:
 *         if arr[data.index] != 1 and arr[data.index] != 8:             # <<<<<<<<<<<<<<
 *             print "ARRAY CLUE: ", arr[data.index], "UNKNOWN"
 *             raise RuntimeError
 */
    __pyx_t_1 = (((__pyx_v_arr[__pyx_v_data->index]) != 1) != 0);
    if (__pyx_t_1) {
      __pyx_t_3 = (((__pyx_v_arr[__pyx_v_data->index]) != 8) != 0);
      __pyx_t_4 = __pyx_t_3;
    } else {
      __pyx_t_4 = __pyx_t_1;
    }
    if (__pyx_t_4) {
      ...
      /* "yt/geometry/oct_visitors.pyx":209
 *     elif arr[data.index] > 0:
 *         if arr[data.index] != 1 and arr[data.index] != 8:
 *             print "ARRAY CLUE: ", arr[data.index], "UNKNOWN"             # <<<<<<<<<<<<<<
 *             raise RuntimeError
 *         if o.children == NULL:
 */
      __pyx_t_5 = __Pyx_PyInt_From_npy_uint8((__pyx_v_arr[__pyx_v_data->index])); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 209; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      ...
      __Pyx_INCREF(__pyx_kp_s_ARRAY_CLUE);
      PyTuple_SET_ITEM(__pyx_t_6, 0, __pyx_kp_s_ARRAY_CLUE);
      __Pyx_GIVEREF(__pyx_kp_s_ARRAY_CLUE);
      PyTuple_SET_ITEM(__pyx_t_6, 1, __pyx_t_5);
      __Pyx_GIVEREF(__pyx_t_5);
      __Pyx_INCREF(__pyx_n_s_UNKNOWN);
      PyTuple_SET_ITEM(__pyx_t_6, 2, __pyx_n_s_UNKNOWN);
      __Pyx_GIVEREF(__pyx_n_s_UNKNOWN);
      __pyx_t_5 = 0;
      if (__Pyx_Print(0, __pyx_t_6, 1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 209; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_DECREF(__pyx_t_6); __pyx_t_6 = 0;

      /* "yt/geometry/oct_visitors.pyx":210
 *         if arr[data.index] != 1 and arr[data.index] != 8:
 *             print "ARRAY CLUE: ", arr[data.index], "UNKNOWN"
 *             raise RuntimeError             # <<<<<<<<<<<<<<
 *         if o.children == NULL:
 ...
 */
    ...
    /* "yt/geometry/oct_visitors.pyx":211
 *             print "ARRAY CLUE: ", arr[data.index], "UNKNOWN"
 *             raise RuntimeError
 *         if o.children == NULL:             # <<<<<<<<<<<<<<
 *             o.children = <Oct **> malloc(sizeof(Oct *) * 8)
 ...
 */
    ...
    if (__pyx_t_4) {
      ...
      /* "yt/geometry/oct_visitors.pyx":212
 *             raise RuntimeError
 *         if o.children == NULL:
 *             o.children = <Oct **> malloc(sizeof(Oct *) * 8)             # <<<<<<<<<<<<<<
 *             for i in range(8):
 ...
 */
      ...
      /* "yt/geometry/oct_visitors.pyx":213
 *         if o.children == NULL:
 *             o.children = <Oct **> malloc(sizeof(Oct *) * 8)
 *             for i in range(8):             # <<<<<<<<<<<<<<
 *                 o.children[i] = NULL
 ...
 */
      for (__pyx_t_7 = 0; __pyx_t_7 < 8; __pyx_t_7+=1) {
        ...
        /* "yt/geometry/oct_visitors.pyx":214
 *             o.children = <Oct **> malloc(sizeof(Oct *) * 8)
 *             for i in range(8):
 *                 o.children[i] = NULL             # <<<<<<<<<<<<<<
 *         for i in range(8):
 ...
 */
        (__pyx_v_o->children[__pyx_v_i]) = NULL;
      }
      goto __pyx_L6;
    }
    __pyx_L6:;

    /* "yt/geometry/oct_visitors.pyx":215
 *             for i in range(8):
 *                 o.children[i] = NULL
 *         for i in range(8):             # <<<<<<<<<<<<<<
 *             o.children[ii + i] = &octs[nocts[0]]
 ...
 */
    for (__pyx_t_7 = 0; __pyx_t_7 < 8; __pyx_t_7+=1) {
      ...
      /* "yt/geometry/oct_visitors.pyx":216
 *                 o.children[i] = NULL
 *         for i in range(8):
 *             o.children[ii + i] = &octs[nocts[0]]             # <<<<<<<<<<<<<<
 *             o.children[ii + i].domain_ind = nocts[0]
 ...
 */
      (__pyx_v_o->children[(__pyx_v_ii + __pyx_v_i)]) = (&(__pyx_v_octs[(__pyx_v_nocts[0])]));

      /* "yt/geometry/oct_visitors.pyx":217
 *         for i in range(8):
 *             o.children[ii + i] = &octs[nocts[0]]
 *             o.children[ii + i].domain_ind = nocts[0]             # <<<<<<<<<<<<<<
 *             o.children[ii + i].file_ind = -1
 ...
 */
      (__pyx_v_o->children[(__pyx_v_ii + __pyx_v_i)])->domain_ind = (__pyx_v_nocts[0]);

      /* "yt/geometry/oct_visitors.pyx":218
 *             o.children[ii + i] = &octs[nocts[0]]
 *             o.children[ii + i].domain_ind = nocts[0]
 *             o.children[ii + i].file_ind = -1             # <<<<<<<<<<<<<<
 *             o.children[ii + i].domain = -1
 ...
 */
      (__pyx_v_o->children[(__pyx_v_ii + __pyx_v_i)])->file_ind = -1;

      /* "yt/geometry/oct_visitors.pyx":219
 *             o.children[ii + i].domain_ind = nocts[0]
 *             o.children[ii + i].file_ind = -1
 *             o.children[ii + i].domain = -1             # <<<<<<<<<<<<<<
 *             o.children[ii + i].children = NULL
 *             nocts[0] += 1
 */
      (__pyx_v_o->children[(__pyx_v_ii + __pyx_v_i)])->domain = -1;

      /* "yt/geometry/oct_visitors.pyx":220
 *             o.children[ii + i].file_ind = -1
 *             o.children[ii + i].domain = -1
 *             o.children[ii + i].children = NULL             # <<<<<<<<<<<<<<
 *             nocts[0] += 1
 *     else:
 */
      (__pyx_v_o->children[(__pyx_v_ii + __pyx_v_i)])->children = NULL;

      /* "yt/geometry/oct_visitors.pyx":221
 *             o.children[ii + i].domain = -1
 *             o.children[ii + i].children = NULL
 *             nocts[0] += 1             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
      __pyx_t_2 = 0;
      (__pyx_v_nocts[__pyx_t_2]) = ((__pyx_v_nocts[__pyx_t_2]) + 1);
    }
    goto __pyx_L3;
  }
  /*else*/ {

    /* "yt/geometry/oct_visitors.pyx":223
 *             nocts[0] += 1
 *     else:
 *         print "SOMETHING IS AMISS", data.index             # <<<<<<<<<<<<<<
 *         raise RuntimeError
 *     data.index += 1
 */
    __pyx_t_6 = __Pyx_PyInt_From_npy_uint64(__pyx_v_data->index); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 223; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_6);
    ...
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_INCREF(__pyx_kp_s_SOMETHING_IS_AMISS);
    PyTuple_SET_ITEM(__pyx_t_5, 0, __pyx_kp_s_SOMETHING_IS_AMISS);
    __Pyx_GIVEREF(__pyx_kp_s_SOMETHING_IS_AMISS);
    ...
    /* "yt/geometry/oct_visitors.pyx":224
 *     else:
 *         print "SOMETHING IS AMISS", data.index
 *         raise RuntimeError             # <<<<<<<<<<<<<<
 *     data.index += 1
 */
  ...
  /* "yt/geometry/oct_visitors.pyx":225
 *         print "SOMETHING IS AMISS", data.index
 *         raise RuntimeError
 *     data.index += 1             # <<<<<<<<<<<<<<
 */
 ...
 */
  ...
  __Pyx_WriteUnraisable("yt.geometry.oct_visitors.load_octree", __pyx_clineno, __pyx_lineno, __pyx_filename, 0);
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
}

/* "yt/geometry/oct_visitors.pxd":63
...
static CYTHON_INLINE int __pyx_f_2yt_8geometry_12oct_visitors_cind(int __pyx_v_i, int __pyx_v_j, int __pyx_v_k) {
  ...
  /* "yt/geometry/oct_visitors.pxd":65
 * cdef inline int cind(int i, int j, int k):
 *     # THIS ONLY WORKS FOR CHILDREN.  It is not general for zones.
 *     return (((i*2)+j)*2+k)             # <<<<<<<<<<<<<<
 * 
...
/* "yt/geometry/oct_visitors.pxd":67
 *     return (((i*2)+j)*2+k)
 * 
 * cdef inline int oind(OctVisitorData *data):             # <<<<<<<<<<<<<<
...
static CYTHON_INLINE int __pyx_f_2yt_8geometry_12oct_visitors_oind(struct __pyx_t_2yt_8geometry_12oct_visitors_OctVisitorData *__pyx_v_data) {
  ...
  /* "yt/geometry/oct_visitors.pxd":68
 * 
 * cdef inline int oind(OctVisitorData *data):
 *     cdef int d = (1 << data.oref)             # <<<<<<<<<<<<<<
 *     return (((data.ind[0]*d)+data.ind[1])*d+data.ind[2])
 ...
 */
  ...
  /* "yt/geometry/oct_visitors.pxd":69
 * cdef inline int oind(OctVisitorData *data):
 *     cdef int d = (1 << data.oref)
 *     return (((data.ind[0]*d)+data.ind[1])*d+data.ind[2])             # <<<<<<<<<<<<<<
 * 
...
/* "yt/geometry/oct_visitors.pxd":71
 *     return (((data.ind[0]*d)+data.ind[1])*d+data.ind[2])
 * 
 * cdef inline int rind(OctVisitorData *data):             # <<<<<<<<<<<<<<
 *     cdef int d = (1 << data.oref)
...
static CYTHON_INLINE int __pyx_f_2yt_8geometry_12oct_visitors_rind(struct __pyx_t_2yt_8geometry_12oct_visitors_OctVisitorData *__pyx_v_data) {
  ...
  /* "yt/geometry/oct_visitors.pxd":72
 * 
 * cdef inline int rind(OctVisitorData *data):
 *     cdef int d = (1 << data.oref)             # <<<<<<<<<<<<<<
 *     return (((data.ind[2]*d)+data.ind[1])*d+data.ind[0])
 */
  ...
  /* "yt/geometry/oct_visitors.pxd":73
 * cdef inline int rind(OctVisitorData *data):
 *     cdef int d = (1 << data.oref)
 *     return (((data.ind[2]*d)+data.ind[1])*d+data.ind[0])             # <<<<<<<<<<<<<<
 */
...
static struct PyModuleDef __pyx_moduledef = {
  ...
  #endif
    __Pyx_NAMESTR("oct_visitors"),
    __Pyx_DOCSTR(__pyx_k_Oct_visitor_functions), /* m_doc */
    -1, /* m_size */
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  {&__pyx_kp_s_ARRAY_CLUE, __pyx_k_ARRAY_CLUE, sizeof(__pyx_k_ARRAY_CLUE), 0, 0, 1, 0},
  {&__pyx_kp_u_Format_string_allocated_too_shor, __pyx_k_Format_string_allocated_too_shor, sizeof(__pyx_k_Format_string_allocated_too_shor), 0, 1, 0, 0},
  {&__pyx_kp_u_Format_string_allocated_too_shor_2, __pyx_k_Format_string_allocated_too_shor_2, sizeof(__pyx_k_Format_string_allocated_too_shor_2), 0, 1, 0, 0},
  {&__pyx_kp_u_Non_native_byte_order_not_suppor, __pyx_k_Non_native_byte_order_not_suppor, sizeof(__pyx_k_Non_native_byte_order_not_suppor), 0, 1, 0, 0},
  {&__pyx_n_s_RuntimeError, __pyx_k_RuntimeError, sizeof(__pyx_k_RuntimeError), 0, 0, 1, 1},
  {&__pyx_kp_s_SOMETHING_IS_AMISS, __pyx_k_SOMETHING_IS_AMISS, sizeof(__pyx_k_SOMETHING_IS_AMISS), 0, 0, 1, 0},
...
static int __Pyx_InitCachedBuiltins(void) {
  ...
  __pyx_builtin_RuntimeError = __Pyx_GetBuiltinName(__pyx_n_s_RuntimeError); if (!__pyx_builtin_RuntimeError) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 210; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initoct_visitors(void); /*proto*/
PyMODINIT_FUNC initoct_visitors(void)
#else
PyMODINIT_FUNC PyInit_oct_visitors(void); /*proto*/
PyMODINIT_FUNC PyInit_oct_visitors(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_oct_visitors(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("oct_visitors"), __pyx_methods, __Pyx_DOCSTR(__pyx_k_Oct_visitor_functions), 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_yt__geometry__oct_visitors) {
    if (__Pyx_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;};
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    if (!PyDict_GetItemString(modules, "yt.geometry.oct_visitors")) {
      if (unlikely(PyDict_SetItemString(modules, "yt.geometry.oct_visitors", __pyx_m) < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  if (__Pyx_ExportFunction("count_total_octs", (void (*)(void))__pyx_f_2yt_8geometry_12oct_visitors_count_total_octs, "void (struct __pyx_t_2yt_8geometry_12oct_visitors_Oct *, struct __pyx_t_2yt_8geometry_12oct_visitors_OctVisitorData *, __pyx_t_5numpy_uint8_t)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ExportFunction("count_total_cells", (void (*)(void))__pyx_f_2yt_8geometry_12oct_visitors_count_total_cells, "void (struct __pyx_t_2yt_8geometry_12oct_visitors_Oct *, struct __pyx_t_2yt_8geometry_12oct_visitors_OctVisitorData *, __pyx_t_5numpy_uint8_t)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ExportFunction("mark_octs", (void (*)(void))__pyx_f_2yt_8geometry_12oct_visitors_mark_octs, "void (struct __pyx_t_2yt_8geometry_12oct_visitors_Oct *, struct __pyx_t_2yt_8geometry_12oct_visitors_OctVisitorData *, __pyx_t_5numpy_uint8_t)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ExportFunction("mask_octs", (void (*)(void))__pyx_f_2yt_8geometry_12oct_visitors_mask_octs, "void (struct __pyx_t_2yt_8geometry_12oct_visitors_Oct *, struct __pyx_t_2yt_8geometry_12oct_visitors_OctVisitorData *, __pyx_t_5numpy_uint8_t)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ExportFunction("index_octs", (void (*)(void))__pyx_f_2yt_8geometry_12oct_visitors_index_octs, "void (struct __pyx_t_2yt_8geometry_12oct_visitors_Oct *, struct __pyx_t_2yt_8geometry_12oct_visitors_OctVisitorData *, __pyx_t_5numpy_uint8_t)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ExportFunction("icoords_octs", (void (*)(void))__pyx_f_2yt_8geometry_12oct_visitors_icoords_octs, "void (struct __pyx_t_2yt_8geometry_12oct_visitors_Oct *, struct __pyx_t_2yt_8geometry_12oct_visitors_OctVisitorData *, __pyx_t_5numpy_uint8_t)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ExportFunction("ires_octs", (void (*)(void))__pyx_f_2yt_8geometry_12oct_visitors_ires_octs, "void (struct __pyx_t_2yt_8geometry_12oct_visitors_Oct *, struct __pyx_t_2yt_8geometry_12oct_visitors_OctVisitorData *, __pyx_t_5numpy_uint8_t)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ExportFunction("fcoords_octs", (void (*)(void))__pyx_f_2yt_8geometry_12oct_visitors_fcoords_octs, "void (struct __pyx_t_2yt_8geometry_12oct_visitors_Oct *, struct __pyx_t_2yt_8geometry_12oct_visitors_OctVisitorData *, __pyx_t_5numpy_uint8_t)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ExportFunction("fwidth_octs", (void (*)(void))__pyx_f_2yt_8geometry_12oct_visitors_fwidth_octs, "void (struct __pyx_t_2yt_8geometry_12oct_visitors_Oct *, struct __pyx_t_2yt_8geometry_12oct_visitors_OctVisitorData *, __pyx_t_5numpy_uint8_t)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ExportFunction("copy_array_f64", (void (*)(void))__pyx_f_2yt_8geometry_12oct_visitors_copy_array_f64, "void (struct __pyx_t_2yt_8geometry_12oct_visitors_Oct *, struct __pyx_t_2yt_8geometry_12oct_visitors_OctVisitorData *, __pyx_t_5numpy_uint8_t)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ExportFunction("copy_array_i64", (void (*)(void))__pyx_f_2yt_8geometry_12oct_visitors_copy_array_i64, "void (struct __pyx_t_2yt_8geometry_12oct_visitors_Oct *, struct __pyx_t_2yt_8geometry_12oct_visitors_OctVisitorData *, __pyx_t_5numpy_uint8_t)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ExportFunction("identify_octs", (void (*)(void))__pyx_f_2yt_8geometry_12oct_visitors_identify_octs, "void (struct __pyx_t_2yt_8geometry_12oct_visitors_Oct *, struct __pyx_t_2yt_8geometry_12oct_visitors_OctVisitorData *, __pyx_t_5numpy_uint8_t)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ExportFunction("assign_domain_ind", (void (*)(void))__pyx_f_2yt_8geometry_12oct_visitors_assign_domain_ind, "void (struct __pyx_t_2yt_8geometry_12oct_visitors_Oct *, struct __pyx_t_2yt_8geometry_12oct_visitors_OctVisitorData *, __pyx_t_5numpy_uint8_t)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ExportFunction("fill_file_indices_oind", (void (*)(void))__pyx_f_2yt_8geometry_12oct_visitors_fill_file_indices_oind, "void (struct __pyx_t_2yt_8geometry_12oct_visitors_Oct *, struct __pyx_t_2yt_8geometry_12oct_visitors_OctVisitorData *, __pyx_t_5numpy_uint8_t)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ExportFunction("fill_file_indices_rind", (void (*)(void))__pyx_f_2yt_8geometry_12oct_visitors_fill_file_indices_rind, "void (struct __pyx_t_2yt_8geometry_12oct_visitors_Oct *, struct __pyx_t_2yt_8geometry_12oct_visitors_OctVisitorData *, __pyx_t_5numpy_uint8_t)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ExportFunction("count_by_domain", (void (*)(void))__pyx_f_2yt_8geometry_12oct_visitors_count_by_domain, "void (struct __pyx_t_2yt_8geometry_12oct_visitors_Oct *, struct __pyx_t_2yt_8geometry_12oct_visitors_OctVisitorData *, __pyx_t_5numpy_uint8_t)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ExportFunction("store_octree", (void (*)(void))__pyx_f_2yt_8geometry_12oct_visitors_store_octree, "void (struct __pyx_t_2yt_8geometry_12oct_visitors_Oct *, struct __pyx_t_2yt_8geometry_12oct_visitors_OctVisitorData *, __pyx_t_5numpy_uint8_t)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (__Pyx_ExportFunction("load_octree", (void (*)(void))__pyx_f_2yt_8geometry_12oct_visitors_load_octree, "void (struct __pyx_t_2yt_8geometry_12oct_visitors_Oct *, struct __pyx_t_2yt_8geometry_12oct_visitors_OctVisitorData *, __pyx_t_5numpy_uint8_t)") < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 1; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  /*--- Type init code ---*/
  /*--- Type import code ---*/
  ...
  /* "yt/geometry/oct_visitors.pyx":19
 * cimport cython
 * cimport numpy
 * import numpy             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "yt/geometry/oct_visitors.pyx":1
 * """             # <<<<<<<<<<<<<<
 * Oct visitor functions
 * 
 */
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_1);
  if (__pyx_m) {
    __Pyx_AddTraceback("init yt.geometry.oct_visitors", __pyx_clineno, __pyx_lineno, __pyx_filename);
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init yt.geometry.oct_visitors");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
